namespace ORP.Domain.Identity;

public sealed class User
{
    private User() { }
    public User(string userName, string displayName, bool isGlobalAdministrator = false)
    { UserName = userName; DisplayName = displayName; IsGlobalAdministrator = isGlobalAdministrator; }
...
public static class Permissions
{
    ...
    public static readonly string[] All = [MessageView, MessageAssign, ReviewLevel1, ReviewLevel2, ReviewLevel3, ReviewUndo, AuditView, WorkflowManage];
}
