...
3. Put the database connection string in the deployed `ORP.Sync.exe.config`. Protect that file with the service account ACL; do not pass the connection string on the command line.
